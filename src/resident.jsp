<%@ page import="java.util.List" %>
    <%@ page import="ResidentDAO" %>
        <%@ page import="ResidentDAO.Resident" %>
                ...
                <main>
                    <section>
                        <form action="AddResidentServlet" method="post" class="resident-form">
                            ...
                            <input type="number" name="age" id="age" required min="18"
                                title="Age must be at least 18"><br>
                    ...
                    <section>
                        ...
                        <table>
                            ...
                            <tbody>
                                <% try { ResidentDAO residentDAO=new ResidentDAO(); List<Resident> residents =
                                    ...
                                    <% } } else { %>
                                        ...
                                        <% } } catch (SQLException e) { e.printStackTrace(); // Log the exception for
                                            debugging %>
                                            <tr>
                                                <td colspan="5">Error retrieving residents: <%= e.getMessage() %>
                                                </td>
                                            </tr>
                                            <% } %>
                            </tbody>
